...
| Difficulty | 🌶️🌶️ | 🌶️ |
| Source Code| [HERE](https://github.com/lwz7512/pycoding/tree/master/arcade)  | [HERE](https://github.com/lwz7512/luacoding) |
...
| session-04 | Simple Animation & Bouncing ball |  Growing and moving need memory |
...
| session-16 | Flappy Bird 2 |  Using tools from others |
| session-17 | Asteroid Smasher 1 |  We dont want put everything in one place |
...
|   🎏 Content   |   🤖 Dev 2DGame with Godot    |   Explanation   |
|----------|:-------------:|------:|
| Game Engine|  [Godot](https://godotengine.org/) | Open source and Innovative design for everyone |
...
| session-08 | Working with RigidBody2D | - |
| session-10 | dodge the creeps | - |
| session-11 | Kinematic_character mini game | - |
...
Namely HarvardX Certificates Course including [CS50X](https://www.edx.org/course/cs50s-introduction-to-computer-science) and [CS50G](https://courses.edx.org/courses/course-v1:HarvardX+CS50G+Games/course/).
...
- CS50X tutoring  at edX 
- CS50G tutoring at edX
