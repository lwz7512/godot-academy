...
export const Branding = () => {
  ...
  const logostl = {width:44, height:44, marginRight:10}
  return (
    <A href="/" fontSize="2xl" fontWeight="semibold" color="#105177"  >
      <Image src="favicon.png" alt="logo" style={logostl} w="full" h="32|40|64" />
      {title}
    </A>
  )
}
